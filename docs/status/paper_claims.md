...
| P5 Zwei-Loop-Interaktion -- Design-/Protokollphase offen | noch keine neue Paper-Sprache: erlaubt ist nur ein targetfreier, falsifizierbarer Entwurf fuer Mutualantwort, Gegenrichtungen, Swap, Distanz, Shape und gemeinsamen Workledger | Implementierung oder Targetlauf vor getrenntem Freeze und Readinessreview; Ladung, intrinsischer Spin, universelles Kraftgesetz, Feldtheorie oder Quantisierung |
