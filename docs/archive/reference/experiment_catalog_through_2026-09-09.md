# Archiv: Experiment-Katalog bis 2026-09-09

Stand: 2026-09-09.

Diese historische Fassung war zugleich Experiment-Katalog, Reproduzierbarkeitsnotiz und
...
| `experiments/current/dynamics/rotation/scalar_memory_rotating_wave_horizon_transfer_gate.py` | Fixed-alpha-Horizonttransfer vor P5-D | Root-, Homotopie- und Ausschlussadapter targetfrei reviewed | strikter v3-Vertrag, fail-closed Stufenfolge und unabhaengiger Ergebnis-Auditor; gemeinsame outward-rounded Intervallkerne tragen Root, Homotopie und dyadischen lokalen Falsifikator; Tail-, LCG-Arnoldi-, Trajektorien- und Kompositionsadapter fehlen; kein Horizontlauf oder P5-D-Versuch 4 autorisiert |
...
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4_source_write_gate.py` | reziproker Source-/Write-Port und kompletter finite-H-Ledger | abgeschlossen, formaler P4-Fail | Ledger besteht; 24/24 Arme falsifizieren die skalare Geradeausantwort. Kein Mechanik-, Spin- oder Massepass |
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4r_phase_metrology_gate.py` | frischer diskreter Acht-Phasen-Holdout mit cancellation-sicherer Metrologie | abgeschlossen, reviewed Chiral-Pass | lokale Identitaeten, Envelopes und Ledger bestehen; `B_C=0.2084215772`, `B_Q=0.1537530855`, 8/8 Support. Vier spiegelverschiedene Paare, kein kontinuierlicher Phasenclaim |
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4r_result_audit.py` | separat implementierte Standardbibliothek-Neuberechnung des P4-R-Roh-JSON | abgeschlossen, agrees | rekonstruiert Registrierung, Metrik-/Ledgerkontakte, Symmetrien, A/B-Tabelle und Entscheidung ohne Target-Runner oder numerische Drittanbieterpakete; teilt dieselbe Simulation |
...
| --- | --- | --- |
| finite Summe, Residuum und analytischer Jacobian | `src/emergenz_knoten/rotating_wave.py`, `src/emergenz_knoten/rotating_wave_interval.py` | direkt wiederverwendet; der targetfreie v3-Rootadapter ruft exakt acht Newtonschritte auf |
| lokale finite-$H$-Krawczyk-Box | `refine_rotating_wave_root`, `certify_rotating_wave_box` | numerischer Kern und v3-Abbildung fuer feste aeussere/innere Boxen getestet; noch kein neuer Root ausgewertet |
| $s$-Homotopieschlauch | `interval_balance_and_jacobian_box`, `certify_rotating_wave_homotopy_box` und v3-Adapter | targetfrei implementiert und reviewed: volle outward-rounded $s$-Scheiben, 64 feste Scheiben, strikter Einschluss und Bildueberlappung; noch keine registrierte Kante ausgewertet |
| lokaler Ausschlussbaum | gemeinsamer Intervallauswerter, finite Krawczyk-Funktion und v3-Vollpartitionspruefung | targetfrei implementiert und reviewed: feste FIFO-Teilung der laengeren normalisierten Kante bis Tiefe 20; Residualausschluss, anderer Root und ungeloestes Blatt bleiben strikt getrennt; noch keine registrierte Domain ausgewertet |
...
| `reports/project/meta/reviews/scalar_memory_loop_p4_actuator_architecture_audit_2026-08-26.md` | P4 Source-/Write-Architekturaudit | Leitet den exakten chirality-konditionierten Orbit-Center-Notch, adjungierte Slotkraefte, den finite-H-Age-Ledger und die erste Ordnung des Ports her. Raw-\(c_H\), dynamische Traeger und explizite Masse werden verworfen. |
| `reports/project/meta/preregistration/scalar_memory_loop_p4_source_write_protocol_2026-08-26.md` | prospektives P4-Source-/Write-Protokoll | Friert L3, \(k=0.25\), 24 Offsetarme, beide Chiralitaeten, channel-off, exakte Ledger-, D0-, Phasen-, Symmetrie- und Geradeausantwortgates vor der Zielausgabe ein. Nur ein reviewed Full-Pass haette P5 geoeffnet. |
| `reports/dynamics/rotation/scalar_memory_loop_p4_source_write_2026-08-26.md` | P4 reziproke Single-Loop-Mechanik | `p4-source-write-architecture-fail`: Der exakte Write-/Age-/Interaktionsledger ist aufgeloest, doch zwei direkte Readout-Residuen scheitern 24/24 an einer cancellation-unaufgeloesten Grenze; unabhaengig verfehlen Center und Aktuator in 24/24 Armen die Orthogonalgrenze. |
| `reports/project/meta/reviews/scalar_memory_loop_p4_source_write_review_2026-08-26.md` | kritisches P4-Review | Haelt den formalen Fail und die P5-Sperre aufrecht. Trennt binary64-Messboden von der bestandenen exakten Arbeitsbilanz und identifiziert die spiegelkonsistente chirality-odd Querantwort nur als neue, startphasenkonditionierte und holdout-pflichtige Matrixsuszeptibilitaets-Hypothese. |
| `reports/project/meta/reviews/scalar_memory_loop_p4r_phase_metrology_design_audit_2026-08-26.md` | P4-R-phi-Designaudit | Korrigiert den alten $x/y$-Vergleich als zwei relative Startphasen, waehlt vor jedem neuen Ziellauf eine uniforme Acht-Phasen-Quadratur und trennt cancellation-sichere Slotidentitaet vom konservativen Full-Dot-Rundungsenvelope. Ein Pass koennte nur P4-R-S am Anchor oeffnen, nicht P5. |
| `reports/project/meta/preregistration/scalar_memory_loop_p4r_phase_metrology_protocol_2026-08-26.md` | prospektives P4-R-phi-Protokoll | Friert 16 phase-spezifische channel-off- und 32 aktive Arme, lokale Increment-Residuen, konservative Full-Dot-Envelopes, eine diskrete Acht-Phasen-Antwort und eine vollstaendige Fail/Null/Chiral/Inconclusive-Entscheidung vor jedem neuen Ziellauf ein. P4 bleibt Fail; auch ein reviewed Chiral-Pass oeffnet nur Referee-Audit plus P4-R-S. |
| `reports/project/meta/preregistration/p4_publication_source_referee_audit_charter_2026-08-26.md` | prospektive Referee-/Source-Readiness-Charter | Friert vor P4-R-Targetzugriff ein internes adversariales Audit der gesamten P0--P4-R-Claimkette ein: saubere Reproduktion, unabhaengige JSON-Neuberechnung, Algebra-/Krawczyk-Trust-Base, Pseudoreplikation, Citation/Environment und maschinenlesbare Findings. Es ersetzt keine externe Peer Review. |
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4r_phase_metrology_gate.py` | ausgefuehrter P4-R-phi-Runner | Implementiert das eingefrorene Acht-Phasen-Panel, cancellation-sichere lokale Identitaeten, konservative binary64-Envelopes, exakte 80-stellige Ratio-Replays und die vollstaendige Entscheidungsrangfolge. Der unveraenderliche Lauf besteht den Chiral-Klassifikator; P4 bleibt Fail. |
| `reports/project/meta/reviews/scalar_memory_loop_p4r_implementation_readiness_2026-08-26.md` | P4-R-phi-Implementierungsreview vor Targetzugriff | Prueft unveraenderte Zustandsoperationen, Metrologie, Subnormal-Fail-safe, exakte Armreihenfolge, Symmetrieabhaengigkeit, Entscheidungsrangfolge und synthetische Falsifikatoren. Das Urteil autorisiert genau den ersten registrierten Lauf aus einem sauberen gepushten Commit, ist aber selbst kein P4-R-Befund. |
| `reports/dynamics/rotation/scalar_memory_loop_p4r_phase_metrology_2026-08-26.md` | P4-R-phi diskrete Phasenantwort | `p4r-phase-averaged-chiral-response-pass`: 16/16 channel-off, 32/32 aktive Arme und 96/96 High-precision-Checkpoints bestehen; diskrete Querantwort `0.2084215772/0.1537530855`, jeweils 8/8 Support. |
...
| `reports/project/meta/preregistration/scalar_memory_loop_p4rs_anchor_scale_protocol_2026-08-30.md` | prospektives P4-R-S-Anchor-Protokoll | Fror vor Implementierung und Targetzugriff 16 channel-off-/32 aktive Arme, Anchor `N=2000`/Stride 5, rohen L3-Vergleich, lokale und Full-dot-Metrologie, kompletten Ledger sowie Pass/Fail/Mismatch/Inconclusive-Praezedenz ein. Zu diesem Freeze-Zeitpunkt existierten Runner und Target noch nicht. |
| `reports/project/meta/reviews/scalar_memory_loop_p4rs_anchor_scale_implementation_readiness_2026-08-30.md` | P4-R-S-Implementierungsreview vor Targetzugriff | Prueft Runner, Abhaengigkeitspins, identische L3-/Anchor-Auswertung, gemeinsame Memory-Zeit, synthetische Falsifikatoren, Ergebnis-Atomizitaet und den versiegelten Targetpfad. Autorisiert genau einen ersten registrierten Lauf aus einem sauberen gepushten Commit. |
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4rs_anchor_scale_gate.py` | ausgefuehrter P4-R-S-Runner | Fuehrt den eingefrorenen Anchor-Holdout ohne Retuning aus: 16 channel-off-, 32 aktive Arme, je 401 gemeinsame Memory-Zeit-Samples, 96 High-precision-Referenzen, kompletter Ledger und vorregistrierte Entscheidungsrangfolge. |
| `reports/dynamics/rotation/scalar_memory_loop_p4rs_anchor_scale_2026-08-30.md` | P4-R-S-Anchor-Skalenholdout | `p4rs-anchor-scale-transfer-pass`: alle geerbten Gates bestehen; die groesste Anchor--L3-Abweichung ist `0.00232715` gegen `epsilon_scale=0.05`, der positive Phasensupport ist fuer Center und Aktuator jeweils 8/8. |
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4rs_result_audit.py` und `reports/project/meta/reviews/p4rs_independent_result_recompute_2026-08-30.json` | unabhaengig implementierter P4-R-S-Ergebnisrebuild | Standardbibliothek-only und ohne Import des Targetrunners oder numerischen Drittanbieter-Stacks; rekonstruiert Anchor-/L3-Antwort, alle Skalierungsarrays, Entscheidungszweige, Ledgergates und 96 Referenzen als `p4rs-independent-audit-agrees` ohne Feldabweichung. Verwendet dieselben gespeicherten Rohtraces und ist daher keine externe Replikation. |
| `reports/project/meta/reviews/scalar_memory_loop_p4rs_anchor_scale_result_review_2026-08-30.md` | kritisches P4-R-S-Ergebnisreview | Haelt nur den registrierten Zwei-Zellen-Skalenpass aufrecht und oeffnet P5-Design sowie prospektive Protokollierung. Keine Konvergenzordnung, unabhaengige Replikation, Single-Loop-Mechanik, Interaktion, Spin-, Impuls-, Traegheits- oder Masseevidenz. P5-Implementierung und Target bleiben geschlossen. |
| `reports/project/meta/reviews/scalar_memory_rotating_wave_noise_stress_result_review_2026-09-01.md` | kritisches N0-Ergebnisreview | Haelt nur die aufgeloeste finite-time Klammer `chi=1e-4` stabil / `1e-3` lokaler Phasen-/Chiralitaetsfail aufrecht. Keine stochastische Formation, physikalische Rauschkalibrierung oder Planck-basierte Wahl von `epsilon`. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_mutual_center_design_audit_2026-09-01.md` und `reports/project/meta/preregistration/scalar_memory_loop_p5d_mutual_center_protocol_2026-09-01.md` | targetfreies P5-D-Design und korrigierter Protokoll-Freeze | Waehlt eine explizite lineare notched-Center-/adjungierte Write-Kopplung, 64 Basen und 832 deterministische Arme. Reflexion nutzt `m -> 7-m`, Swap plus Halbdrehung `m -> (3-m) mod 8`; Target bleibt versiegelt. |
| `experiments/current/dynamics/rotation/scalar_memory_loop_p5d_mutual_center_gate.py`, `scalar_memory_loop_p5d_mutual_center_result_audit.py` und `src/emergenz_knoten/mutual_center_coupling.py` | targetfreie P5-D-Implementierung | Implementiert simultane Off-/Einweg-/Reziprok-Updates, gemeinsamen finite-H-Paarledger, Reservoirbuchung, Metrologie, Panel-/Symmetrie-/Responsegates und einen Runner-unabhaengigen Standardbibliothek-Rebuild. Das spaetere Review widerlegt jedoch die behauptete paarweise Ausgabeatomizitaet. Die synthetischen 832-Arm-Falsifikatoren prueften Panelkardinalitaet und classifier-shaped Records, aber nicht das exakte Produktionsschema eines Channel-off-Arms. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_mutual_center_implementation_readiness_2026-09-01.md` | kritisches P5-D-Implementierungsreview vor Targetzugriff | `p5d-implementation-ready`: prueft sechs Implementierungsblobs, alle zwoelf Pre-target-Falsifikatoren, 64+768 Armregistrierung, 192 High-precision-Checkpoints, Atomizitaet, Provenienz und die Online-Reducer-Auditgrenze. Autorisiert nach eigenem gruenem CI genau einen sauberen Standardlauf; ist keine P5-D- oder Interaktionsevidenz. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_first_target_serialization_failure_2026-09-02.md` | P5-D-Erstaufruf-Incident | `p5d-inconclusive`: Der saubere autorisierte Aufruf erreichte die finale Payload-Serialisierung, scheiterte dort aber an einem NumPy-Bool. Standard-/Temp-Artefakte und beobachtete Entscheidung fehlen; Laufzeit und fehlender Fruehstopp sind keine wissenschaftliche Information. |
| `reports/project/meta/preregistration/scalar_memory_loop_p5d_serialization_recovery_protocol_2026-09-02.md` | outcome-blinde P5-D-Serializer-Recovery | Erlaubt ausschliesslich die fail-closed Konversion von NumPy-Bool-/Integer-/Float-Skalaren fuer JSON, neue targetfreie Tests und ein neues Readinessreview. Panel, Parameter, Gleichungen, Schwellen, Entscheidung, Pfade und Rohresultat-Reihenfolge bleiben unveraendert; ein Ersatzlauf waere keine Replikation. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_serialization_recovery_readiness_2026-09-02.md` | P5-D-Recovery-Readinessreview | Repinnt sechs Implementierungsblobs, 901 Tests und die fail-closed Skalargrenze. Der spaetere Ersatzlauf falsifiziert jedoch die Produktionsschema-Abdeckung: Der synthetische Vollpaneltest enthielt nicht den garantierten Channel-off-`inf`-Sentinel. Die historische Freigabe bleibt als Provenienz erhalten, ist operational aber verbraucht. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_replacement_nonfinite_serialization_failure_2026-09-02.md` | P5-D-Ersatzlauf-Incident und Readiness-Falsifikation | Auch der einzige Ersatzlauf ist `p5d-inconclusive`: `allow_nan=False` lehnt den in allen 64 Channel-off-Armen garantierten, nicht anwendbaren `minimum_dissipation=inf`-Sentinel ab. Keine Standard-/Temp-Artefakte oder beobachtete Entscheidung; kein dritter Lauf oder Patch ohne neues prospektives Governance-Protokoll. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_code_review_2026-09-02.md` | targetfreies adversariales P5-D-Code-Review | Bestaetigt die implementierte Center-/Port-Algebra, findet aber sieben Laufblocker: nicht technisch erzwungene Schliessung, garantiert nichtendliches Off-Schema, fail-open Typpruefung in Runner und Auditor, nicht paarweise atomare Ausgabe, unavailable-render crash, unzureichende CI-Bindung und fehlende exakte Payload-Vorpruefung. Verdict `p5d-runner-not-ready-no-target-authorized`. |
| `reports/project/meta/reviews/model_vocabulary_remediation_audit_2026-09-02.md` und `docs/reference/model_vocabulary.md` | targetfreier Vokabularaudit und aktiver Notationsvertrag | Trennt Paper-I-Grundparameter von Filter- und Portgroessen: $\beta_\rho$ fuer Deposition, $B_H(1)=1$, $b_s$, $a_j^{(s)}$, $\gamma_{\rm w}$, $\mu_{\rm w}$ und $u_{64}$. Historische Artefakte bleiben unveraendert; Code-/JSON-Namen duerfen nur versioniert in der Remediation migrieren. |
| `reports/project/meta/preregistration/scalar_memory_loop_p5d_runner_remediation_protocol_2026-09-03.md` | targetfreies, review-amendiertes P5-D-Runner-Remediation-Protokoll | Friert vor jeder Korrektur den maschinenlesbar geschlossenen Zustand, exakte Receipt-/Manifest-/Schemapfade, eine einmalig konsumierbare UUIDv4-Autorisierung, v2-Payloadtypen, `null`-Semantik fuer den Off-Arm, Manifest als Publikations-Commitpunkt, fest geroutete CI-Provenienz, sieben Schutzpfade und sieben adversariale Testgruppen ein. Kein dritter Ziellauf ist autorisiert. |
| `reports/project/meta/reviews/scalar_memory_loop_p5d_runner_remediation_protocol_review_2026-09-03.md` | adversariales Review des P5-D-Remediation-Protokolls | Bestaetigt `null`-Semantik, Manifest-Commitpunkt und Einmal-Beleg, fordert aber vor Implementierung exakte Beleg-/Manifestpfade, ein getracktes maschinenlesbares Schema, einen fest konstruierten GitHub-Endpunkt, Auditor-Manifestpruefung, feste Schutzpfade und Incident-Bindung. Verdict `p5d-remediation-protocol-needs-amendment`; Target bleibt geschlossen. |
