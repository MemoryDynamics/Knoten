...
| `experiments/current/memory/synchronization/oriented_history_current_audit.py` | geordneter History-Current-Audit | aktiv | polarer Verschiebungs-/Einheitsstrom und antisymmetrische Zirkulation gegen Random-Sign-Null vor einer eigenstaendigen Vektorzustandsdynamik |
