...
| `experiments/current/memory/closure/dynamic_green_kernel_selection_gate.py` | gemeinsamer gradientenfoermiger Write/Readout des Dichte-Strom-Felds | abgeschlossen, struktureller Modellkandidat | zwoelf Gates bestanden; drei dimensionslose Formgruppen, gainfreie Peak-Inversion, antwortsselektiertes `u*=1.0387`, cutoff-robuste attraktive/repulsive Schalen und lineares Paarminimum bei `6.96 ell`; noch keine Knotensimulation oder Koeffizientenselektion |
...
| `reports/memory/closure/dynamic_green_kernel_selection_gate_2026-08-11.md` | P3.8b dynamischer Green-Kernel | zwoelf Gates; positiver Operator, gainfreie Peak-Inversion, intern gewaehlte Skala, cutoff-robuste Schalen und lineares getrenntes Paarminimum; matched Knotentest noch offen. |
