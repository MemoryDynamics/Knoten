...
| `reports/response/long_horizon_hankel_gate_2026-08-04.md` | P3.2 Langhorizont-Hankel | Alle 45 festen Deltas positiv, median `+0.1203`; effektiver Rang waechst, Feld/Impuls hilft nicht und Rang 16/32 trennt sich nicht vom Einwegarm. Keine laengere Persistenz- oder Modenevidenz. |
