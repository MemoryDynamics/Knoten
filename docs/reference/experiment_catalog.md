...
| `experiments/current/topology/s1_p0_manifest_gate.py` | P0-Kandidaten-/Discovery-Freeze | ausgefuehrt, fail mit 27 Manifestdefekten | akkumuliert fehlende Identitaets-, Vollparameter-, State-Hash-, Discovery- und Confirmatory-Seal-Felder; D0/D1 und Ziellauf bleiben blockiert, ohne einen Altkandidaten zu rekonstruieren |
...
| `reports/project/meta/reviews/s1_phase_mass_falsification_program_review_2026-08-16.md` | zweiter Referee-Pass des S1-/Masse-Charters | Nach Revision als Programmgrenze und fuer kandidatenunabhaengige Methodenarbeit geeignet; P0 blockiert weiterhin jeden Ziellauf. Diskreter p-Zyklus ist nicht S1, Raw-cloud-Permutation ist Invarianz statt Null, Seed ist Replikationseinheit und offene Impulsbilanz schliesst Feld/Bath ein. |
