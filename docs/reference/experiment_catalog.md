...
| `experiments/current/memory/synchronization/oriented_source_mediator_identifiability.py` | autonome Source-/Transfer-Identifizierbarkeit | vorregistriert | sechs Sources, zwei Hann-Segmente und exakte DC-normalisierte diskrete Impulsantworten an 18 geerbten Abstaenden; Stopgate vor dynamischem Mediatorvergleich |
