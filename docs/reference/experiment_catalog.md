...
| `experiments/current/memory/synchronization/measurement_closure_relative_noise_gate.py` | P3.2 Mess-Closure, Relative Noise und optionaler Langhorizont-Hankel-Audit | aktiv | gemeinsame Holdout-Zeiten, feste relative Rauschleiter; vorregistrierte Hankel-Tiefen bis 12500 Updates und feste Raenge gegen Einweg-Kontrolle |
