...
| `reports/project/meta/preregistration/scalar_memory_loop_p5d_runner_remediation_protocol_2026-09-03.md` | targetfreies P5-D-Runner-Remediation-Protokoll | Friert vor jeder Korrektur den maschinenlesbar geschlossenen Zustand, eine einmalig konsumierbare Laufautorisierung, v2-Payloadtypen, `null`-Semantik fuer den Off-Arm, Manifest als Publikations-Commitpunkt, remote gebundene CI-Provenienz und sieben adversariale Testgruppen ein. Kein dritter Ziellauf ist autorisiert. |
