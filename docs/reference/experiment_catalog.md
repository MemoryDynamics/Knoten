...
| G5-Komponentenvertrag und Readiness | naechster targetfreier Block | Preflight persistent binden, Backend und Auditor komponieren; kein Ziel vor separatem Review |
