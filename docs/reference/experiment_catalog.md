...
| `experiments/current/dynamics/rotation/scalar_memory_loop_p4r_phase_metrology_gate.py` | prospektiver P4-R-phi-Runner | Implementiert das eingefrorene Acht-Phasen-Panel, cancellation-sichere lokale Identitaeten, konservative binary64-Envelopes, exakte 80-stellige Ratio-Replays und die vollstaendige Entscheidungsrangfolge. Seine Aufnahme allein ist kein Targetbefund; der erste Lauf darf erst aus einem sauberen gepushten Implementierungsstand erfolgen. |
