...
| `experiments/current/dynamics/scaling/scalar_memory_center_finite_h_port_a2.py` | finite-H Center-Port A2-Zertifikat | praeregistriert, Zielfamilie ungeoeffnet | globaler Small-Gain-/Positive-Real-Bound fuer den exakten Tailterm plus nichtentscheidender Frequenzgrid-Sanitycheck; kann nur B-star-Filtertests, nicht physisches B oeffnen |
