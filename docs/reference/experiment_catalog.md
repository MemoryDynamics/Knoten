...
| `experiments/current/memory/synchronization/retarded_reciprocal_full_knot_gate.py` | reziproker Vollknoten ueber festen Telegraph-Kanal | preregistriert | P3.1-`c=0.02`, `lambda=0.01`, `L=5R`, Relaxation `10` Memory-Zeiten und DC-Einheitsnormierung; off/direct/retarded-one-way controls |
