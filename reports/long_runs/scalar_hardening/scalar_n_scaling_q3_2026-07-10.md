...
- `figures/draft/scalar_n/scalar_n_scaling_q3_score_residence_2026-07-10.png`
- `figures/draft/scalar_n/scalar_n_scaling_q3_compactness_2026-07-10.png`
- `figures/draft/scalar_n/scalar_n_scaling_q3_dimensions_2026-07-10.png`

## Raw Rows

- Seed score rows: `40`.
- Machine-readable aggregate: `reports/long_runs/scalar_hardening/scalar_n_scaling_q3_summary_2026-07-10.json`.
