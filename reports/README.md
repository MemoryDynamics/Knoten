...
- Isolierter G4-Pfad: [allgemeine Erklaerung](../docs/reference/horizon_transfer_guide.md), [Komponentenprotokoll](project/meta/preregistration/scalar_memory_rotating_wave_horizon_g4_component_protocol_2026-09-13.md), [Code-Review des numerischen Kerns](project/meta/reviews/scalar_memory_rotating_wave_horizon_g4_code_review_2026-09-13.md), [Readiness-Review](project/meta/reviews/scalar_memory_rotating_wave_horizon_g4_component_readiness_review_2026-09-13.md) und [Review des technisch invaliden Erstlaufs](project/meta/reviews/scalar_memory_rotating_wave_horizon_g4_component_execution_incident_2026-09-13.md)
