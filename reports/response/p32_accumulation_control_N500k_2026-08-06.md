...
- preregistration: `reports/project/meta/p32_accumulation_control_preregistration_2026-08-06.md`;
- git revision: `72ae14528e7a807e9484093c1503e2ec9f3f72a9`;
- git status at start: `clean`;
- base runtime: `404.212 s`;
- command: `python experiments/current/memory/synchronization/p32_accumulation_control.py`;
- machine-readable summary: `reports/response/p32_accumulation_control_N500k_2026-08-06.json`.
