...
- identifiability summary: `reports/response/oriented_source_mediator_identifiability_2026-07-28.json`
...
- runtime: `42.4103 s`
- command: `python experiments/current/memory/synchronization/dynamic_common_source_mediator_gate.py`
