...
- Summary: reports/response/oriented_vector_fixed_pair_distance_gate_2026-07-26.json
- Command: python experiments/current/memory/synchronization/oriented_vector_fixed_pair_distance_gate.py
