...
- Summary: reports/response/scalar/scalar_cross_readout_resolution_2026-07-21.json
- Command: python experiments/current/memory/synchronization/calibration/scalar_cross_readout_resolution.py
