...
- Summary: reports/response/calibration/frozen_source_field_audit_summary_2026-07-17.json
- Command: python experiments/current/memory/synchronization/calibration/frozen_source_field_audit.py
