...
- Static field audit: reports/response/calibration/frozen_source_field_audit_2026-07-17.md
- Summary: reports/response/calibration/frozen_source_distance_ladder_summary_2026-07-17.json
- Command: python experiments/current/memory/synchronization/calibration/frozen_source_distance_ladder.py
