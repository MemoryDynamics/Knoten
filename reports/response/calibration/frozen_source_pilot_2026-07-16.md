...
- Summary: reports/response/calibration/frozen_source_pilot_summary_2026-07-16.json
- Command: python experiments/current/memory/synchronization/calibration/frozen_source_response.py
