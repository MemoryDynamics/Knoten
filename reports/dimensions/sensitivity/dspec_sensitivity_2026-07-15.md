...
- Machine-readable summary: `reports/dimensions/sensitivity/dspec_sensitivity_summary_2026-07-15.json`
- Git revision while building this report: `c93664efd58fd5baacfc3fe6dd12dac52719919c`
- Git status while building this report: `M src/emergenz_knoten/diagnostics.py;  M tests/test_core.py; ?? experiments/current/dimensions/dspec_sensitivity_report.py; ?? figures/draft/dimensions/dspec_sensitivity_2026-07-15/; ?? reports/dimensions/sensitivity/dspec_sensitivity_summary_2026-07-15.json; ?? tests/test_dspec_sensitivity_report.py`
