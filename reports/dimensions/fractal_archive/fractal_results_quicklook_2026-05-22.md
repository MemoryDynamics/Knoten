...
Quelle: `archive_source/data/n_scaling/resultsN.csv` und verwandte `resultsN*.csv` Dateien.
...
Aus `archive_source/data/n_scaling/resultsN.csv`:
...
- Den genauen Parametervektor fuer diese CSV-Zeilen manifestieren. Aus
  `archive_source/scripts/FD2.py` ist fuer die Scaling-Analyse wahrscheinlich:
...
Der fruehere kurze Scan `archive_source/data/base/scan_results.txt` zeigt Mittelwerte nur bis
