...
- `experiments/fractal_analysis/archive_source/scripts/FD2.py`
- `experiments/fractal_analysis/archive_source/scripts/Fraktaldimension.py`
- `experiments/fractal_analysis/archive_source/scripts/fit_n_plot.py`
- `experiments/fractal_analysis/archive_source/scripts/analyze_peaks.py`
- `experiments/fractal_analysis/archive_source/data/base/results.csv`
- `experiments/fractal_analysis/archive_source/data/n_scaling/resultsN.csv`
- `experiments/fractal_analysis/archive_source/resultsN_*.csv`
- `docs/historical/chatgpt/topics/Fraktaldimensionen.md`
