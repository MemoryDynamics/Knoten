...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--alpha", type=float, default=0.01, help="Memory decay parameter")
...
def main() -> None:
    ...
    stats = {
        ...
        "D_occ_stats": summarize(d_occ_values) if d_occ_values else {"mean": float("nan"), "std": float("nan"), "ci_95_lo": float("nan"), "ci_95_hi": float("nan")},
        "D_spec_stats": summarize(d_spec_values) if d_spec_values else {"mean": float("nan"), "std": float("nan"), "ci_95_lo": float("nan"), "ci_95_hi": float("nan")},
    }
