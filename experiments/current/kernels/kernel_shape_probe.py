...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--figure",
        type=Path,
        default=Path("figures/draft/kernels/kernel_shape_probe_2026-07-01.svg"),
    )
    parser.add_argument(
        "--seed-figure",
        type=Path,
        default=Path("figures/draft/kernels/kernel_seed_probe_2026-07-02.svg"),
    )
    parser.add_argument(
        "--flexible-figure",
        type=Path,
        default=Path("figures/draft/kernels/kernel_shape_probe_flexible_2026-07-02.svg"),
    )
    parser.add_argument(
        "--flexible-seed-figure",
        type=Path,
        default=Path("figures/draft/kernels/kernel_seed_probe_flexible_2026-07-02.svg"),
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/kernels/shape_and_memory/kernel_shape_probe_2026-07-01.md"),
    )
