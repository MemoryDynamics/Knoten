...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/memory/closure/low_mode_ar_feature_closure_2026-07-19.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/memory/closure/low_mode_ar_feature_closure_2026-07-19.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
...
def _report(payload: dict[str, Any], report_path: Path, figure_path: Path) -> str:
    ...
    lines.extend(
        [
            ...
            "Run:",
            "",
            "    python experiments/current/memory/closure/low_mode_ar_feature_closure.py",
            "",
