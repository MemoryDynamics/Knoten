...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "reports/memory/closure/adjoint_reciprocity_eligibility_audit_2026-08-07.md"
        ),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path(
            "reports/memory/closure/adjoint_reciprocity_eligibility_audit_2026-08-07.json"
        ),
    )
    parser.add_argument(
        "--figure",
