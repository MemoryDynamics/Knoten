...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/memory/representations/spectral_rho_field_pilot_2026-07-19.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/memory/representations/spectral_rho_field_pilot_2026-07-19.json"),
    )
    parser.add_argument(
        "--metrics-figure",
        type=Path,
