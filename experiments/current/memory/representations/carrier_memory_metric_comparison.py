...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/memory/representations/carrier_memory_metric_comparison_2026-08-08.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/memory/representations/carrier_memory_metric_comparison_2026-08-08.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
