...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/calibration/weak_probe_calibration_2026-07-16.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/response/calibration/weak_probe_calibration_summary_2026-07-16.json"),
    )
    parser.add_argument(
        "--figure-dir",
        type=Path,
