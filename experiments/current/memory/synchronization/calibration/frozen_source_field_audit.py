...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/calibration/frozen_source_field_audit_2026-07-17.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path(
            "reports/response/calibration/frozen_source_field_audit_summary_2026-07-17.json"
        ),
    )
    parser.add_argument(
        "--figure-dir",
