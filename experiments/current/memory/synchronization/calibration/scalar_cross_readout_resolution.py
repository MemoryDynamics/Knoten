...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/scalar/scalar_cross_readout_resolution_2026-07-21.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path(
            "reports/response/scalar/scalar_cross_readout_resolution_2026-07-21.json"
        ),
    )
    parser.add_argument(
        "--figure",
