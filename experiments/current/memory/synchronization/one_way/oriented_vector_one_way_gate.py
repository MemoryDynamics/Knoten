...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/oriented/oriented_vector_one_way_gate_2026-07-25.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/response/oriented/oriented_vector_one_way_gate_2026-07-25.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
