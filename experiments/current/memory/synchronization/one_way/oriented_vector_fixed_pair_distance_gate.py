...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "reports/response/oriented/oriented_vector_fixed_pair_distance_gate_2026-07-26.md"
        ),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path(
            "reports/response/oriented/oriented_vector_fixed_pair_distance_gate_2026-07-26.json"
        ),
    )
    parser.add_argument(
        "--figure",
