...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/one_way/one_way_dynamic_source_pilot_2026-07-20.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/response/one_way/one_way_dynamic_source_pilot_2026-07-20.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
