...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/one_way/one_way_interaction_age_N1M_2026-07-21.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/response/one_way/one_way_interaction_age_N1M_2026-07-21.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
