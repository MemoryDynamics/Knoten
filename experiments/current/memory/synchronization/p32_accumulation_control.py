...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/p32_accumulation_control_N500k_2026-08-06.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/response/p32_accumulation_control_N500k_2026-08-06.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
