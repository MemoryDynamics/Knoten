...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("reports/response/reciprocal/long_horizon_hankel_gate_2026-08-04.json"),
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/response/reciprocal/hankel_pole_identity_audit_2026-08-06.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/response/reciprocal/hankel_pole_identity_audit_2026-08-06.json"),
    )
    parser.add_argument(
        "--figure",
        type=Path,
