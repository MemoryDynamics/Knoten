...
| 6 | `scalar_memory_rotating_wave_foundation_audit.py` | Hash-/Provenienzcheck, unabhaengige finite-Summen-Replays, zwei Multipraezisions-Kontinuumspanels und Skalierungs-Replay | scoped Reconciliation-Pass |
...
Der Audit verlangt einen sauberen Arbeitsbaum und die exakt gehashten
historischen Inputs:
