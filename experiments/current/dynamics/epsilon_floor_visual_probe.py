...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--figure", type=Path, default=Path("figures/draft/epsilon/epsilon_floor_trajectories_flexible_2026-07-02.svg"))
    parser.add_argument("--report", type=Path, default=Path("reports/kernels/epsilon/epsilon_floor_visual_probe_2026-07-02.md"))
