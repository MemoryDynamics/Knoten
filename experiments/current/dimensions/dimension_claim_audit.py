...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("reports/dimensions/claims/dimension_claim_audit_2026-07-15.md"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("reports/dimensions/claims/dimension_claim_audit_summary_2026-07-15.json"),
    )
    parser.add_argument(
        "--figure-dir",
        type=Path,
