...
In the general finite-measure formulation, the memory update carries an
independent forgetting rate $\lambda_{\mathrm m}$ and deposition strength
$\beta$. Paper~0 uses this form as the mathematical anchor. Paper~I mostly
works in the normalized convention $\lambda_{\mathrm m}=\beta=\alpha$, in
...
These numbers support the limited Paper-I statement that the scalar memory feedback can generate seed-stable, co-moving compact memory-cloud candidates in this parameter slice.
...
We therefore treat the local three-dimensional memory shape as a Paper-I diagnostic and as motivation for Paper-II tests of external/coarse dimensionality, not as a conclusion of the present minimal model.
