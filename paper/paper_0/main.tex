...
exponential forgetting. The manuscript is intended as a technical anchor or
supplementary mathematical note, not as standalone numerical evidence for
robust knot formation. The visible trajectory is generally non-Markovian:
...
The purpose of this paper is deliberately narrow. It is best read as a
technical anchor for Paper I, or as supplementary material if Paper I becomes
the primary narrative paper. We do not attempt to derive
...
where
\[
T_x(\rho)=(1-\lambda_{\mathrm m})\rho+\beta G_\sigma(\cdot-x).
\]
